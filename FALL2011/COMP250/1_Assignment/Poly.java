...
public class Poly {
    ...
    /****************************************************************
     * Was started before the modifications made to Poly.java.      *
     * I diffed the versions and added the modifications            *
     **************************************************************** 
     * */
    ...
    public void clean() {
        for (int i = coefficients.length - 1; i >= 0 ; i--) {
            ...
            if (i - 1 >=0 && Math.abs(coefficients[i - 1]) > 0.00000001) {
                break;
            }
        }
    }
    ...
    public static void main(String[] argv) throws Exception {
        ...
        double aoeu = 2;
        Poly tester3 = new Poly(new float[] {1});
